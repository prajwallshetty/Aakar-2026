  ...
  return (
    <div className="flex items-center justify-center h-screen">
      ...
      <form className="flex flex-col gap-4">
        ...
        <button className="bg-red-900 text-white py-2 px-4 rounded-full  hover:bg-red-900 w-32 cursor-pointer">
          Login
        </button>
        <button className=" text-red-900 py-2 px-4 rounded-full  border-red-900 border-2 w-32 cursor-pointer">
    ...
    <div className="h-96 w-68 bg-transparent absolute bottom-0 left-[-38]">
