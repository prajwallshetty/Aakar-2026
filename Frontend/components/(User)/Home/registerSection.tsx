    ...
    return (
        <section className="flex items-center justify-center text-white px-6 py-12 relative">
            <div className="text-center "> <h2 className="text-3xl md:text-5xl font-light pb-12">
                ...
                <button className='bg-[#AA1F26] cursor-pointer hover:bg-red-700 text-white font-[Inter] font-light py-4 px-6 rounded-full text-xl leading-none'>Register Now</button>
            </div>
        </section >
    )
}
