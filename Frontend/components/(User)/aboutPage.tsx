  ...
  return (
    <main className="min-h-screen flex flex-col">
      ...
      <div 
        ...
        // style={{ backgroundImage: "url('/Backgroundnew.png')" }}
      >
        <div className="container mx-auto max-w-6xl"> {/* Increased max-w-5xl to max-w-6xl */}
          ...
          <div className="rounded-xl shadow-md overflow-hidden mt-12 p-8 md:p-12 border-2 border-transparent">
            <div className="max-w-4xl mx-auto"> {/* Increased max-w-3xl to max-w-4xl */}
              {/* Heading */}
              <h2 className="text-4xl font-bold text-center text-white mb-8">
                Shree Devi Samaramb
              </h2>

              {/* Date and Address Boxes */}
