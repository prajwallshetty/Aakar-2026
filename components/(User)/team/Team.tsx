...
const teamData: TeamCategory[] = [
  ...
  },
  {
    name: "Core Committee",
    members: [
      { name: "Aman Hasan",      role: "Event Head",                      image: "/Team/Core-Committee/ayan.jpg"      },
      { name: "Ankitha",         role: "Sponsorship & finance Head",      image: "/Team/Core-Committee/aawan.jpg"     },
      { name: "Rishitha",        role: "Public Relation(PR) Head",        image: "/Team/Core-Committee/anaum.jpg"     },
      { name: "Ayisha",          role: "Designs & Creatives Head",        image: "/Team/Core-Committee/shreya.jpg"    },
      { name: "Pratham",         role: "Operations Manager",              image: "/Team/Core-Committee/thashvy.jpg"  },
      { name: "Rahul",           role: "Social Media manager",            image: "/Team/Core-Committee/manya.jpg"    },
      { name: "Monith",          role: "Event Coordinator",               image: "/Team/Core-Committee/sahana.jpg"   },
      { name: "Dhyan",           role: "Content & Media Head",            image: "/Team/Core-Committee/gauresh.png"  },
      { name: "Rithvik",         role: "Merchandise Lead",                image: "/Team/Core-Committee/monith.jpg"   },
      { name: "Pooja",           role: "Marketing & Promotions Head",     image: "/Team/Core-Committee/Jnanesh.jpg"  },
      { name: "Niresh",          role: "Technical Head",                  image: "/Team/Core-Committee/nishant.jpg"  },
      { name: "sudheeksha",      role: "Registration & Help Desk Head",   image: "/Team/Core-Committee/thanisha.jpg" },
      { name: "Surakshith",      role: "Logistics & Venue Head",          image: "/Team/Core-Committee/farhan.jpg"   },
    ],
  },
];
